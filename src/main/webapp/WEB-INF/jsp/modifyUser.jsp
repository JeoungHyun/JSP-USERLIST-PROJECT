...
<script type="text/javascript">
	...
	var userIdChkState = true;
	var userPwdChkState = true;
	var userEmailState = true;
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4"
						...
						<div class="card-header py-3"
							...
							<div class="row gx-3">
								<div class="mb-3">
									<button style="width: 100px; margin-left: 370px;background-color: ${color}"
										onclick="userMod()" class="btn btn-primary" type="button">
										<i class="fas fa-fw fa-reply" style="margin-right: 10px"></i>수정
									</button>
								</div>
								<div class="mb-3">
									<button onclick="userDel()"
										style="width: 100px; margin-left: 15px;background-color: ${color}"
							...
							<form class="text-dark">
								...
								<div class="row gx-3">
									...
									<div class="mb-3">
										<input value="${uservo.userFirstName }"
											oninput="userNameInput(event)" class="form-control"
									...
									<div class="mb-3">
										<input value="${uservo.userLastName }"
											oninput="userNameInput(event)" class="form-control"
								...
								<div class="row gx-3">
									...
									<div class="mb-3">
										<input disabled="disabled" value="${uservo.userId }"
											onInput="idChkInput(event)" class="form-control"
											name="userId" id="userId" maxlength="50" type="text">
									</div>
								...
								<div class="row gx-3">
									...
									<div class="mb-3">
										<input value="${uservo.userPassword}" class="form-control"
											id="userPassword1" type="password"
								...
								<div class="row gx-3">
									...
									<div class="mb-3" style="display: flex">
										<input value=${uservo.userPhoneNumber.split("-")[0] }
											oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
											class="form-control" id="userPhoneNumber1" type="text"
											maxlength="3" style="width:55px">
										<h3>-</h3><input value=${uservo.userPhoneNumber.split("-")[1] }
											oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
											class="form-control" id="userPhoneNumber2" type="text"
											maxlength="4" style="width:65px">
										<h3>-</h3><input value=${uservo.userPhoneNumber.split("-")[2] }
											oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
								...
								<div class="row gx-3">
									...
									<div class="mb-3" style="display: flex">
										<input style="width:55px"
											oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
											class="form-control" id="userHomeNumber1"
											value="${uservo.userHomeNumber.split("-")[0]}" type="text" maxlength="11">
										<h3>-</h3><input style="width:65px"
											oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
											class="form-control" id="userHomeNumber2"
											value="${uservo.userHomeNumber.split("-")[1]}" type="text" maxlength="11">
										<h3>-</h3><input style="width:65px"
											oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
											class="form-control" id="userHomeNumber3"
											value="${uservo.userHomeNumber.split("-")[2]}" type="text" maxlength="11">
									</div>
								</div>
								<div class="row gx-3">
									<div class="mb-3">
									...
									<div class="mb-3">
										<input value="${uservo.userEmail}" onblur="emailChk()"
											class="form-control" id="userEmail" type="text"
											maxlength="255">
									</div>
								</div>
								<div class="row gx-3">
									...
									<div class="mb-3">
										<input value="${uservo.userZipCode }" disabled="disabled"
											name="zipcode" id="zipcode" class="form-control" type="text">
									</div>
									<div class="mb-3">
								...
								<div class="row gx-3">
									...
									<div class="mb-3">
										<input value="${uservo.userRoadName }" disabled="disabled"
											name="adress" id="adress" style="width: 570px"
								...
								<div class="row gx-3">
									...
									<div class="mb-3">
										<input value="${uservo.userDetailAdress }"
											style="width: 570px" class="form-control"
										...
										<select style="width: 211px;"
											...
											<c:forEach var="item" items="${department}">
												<option value="${item.code}"
													${uservo.userDepartment == item.code ? 'selected="selected"' : ''}>${item.codeName}</option>
											</c:forEach>
										</select>
									</div>
								</div>
									...
									<div class="mb-3">
										<select style="width: 211px;"
											...
											<c:forEach var="item" items="${jopGrade}">
												<option value="${item.code}"
													${uservo.userRank == item.code ? 'selected="selected"' : ''}>${item.codeName}</option>
											</c:forEach>
										</select>
									</div>
								</div>
									...
									<div class="mb-3">
										<select style="width: 211px;"
											...
											<c:forEach var="item" items="${jobPosition}">
												<option value="${item.code}"
													${uservo.userPosition == item.code ? 'selected="selected"' : ''}>${item.codeName}</option>
											</c:forEach>
										</select>
									</div>
								</div>
